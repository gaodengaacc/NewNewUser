...
import com.lyun.user.im.main.viewholder.CustomNotificationViewHolder;
...
public class CustomNotificationActivity extends UI implements TAdapterDelegate {
    ...
    private void selectCustomNotificationTarget(boolean team) {
        ...
        option.title = NimCache.getContext().getString(R.string.select_custom_notification_target);
        option.multi = false;
