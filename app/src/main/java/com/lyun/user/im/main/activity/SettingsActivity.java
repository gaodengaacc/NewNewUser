package com.lyun.user.im.main.activity;
...
import com.lyun.user.im.avchat.activity.AVChatSettingsActivity;
import com.lyun.user.im.config.preference.Preferences;
import com.lyun.user.im.config.preference.UserPreferences;
import com.lyun.user.im.contact.activity.UserProfileSettingActivity;
import com.lyun.user.im.main.adapter.SettingsAdapter;
import com.lyun.user.im.main.model.SettingTemplate;
import com.lyun.user.im.main.model.SettingType;
...
//                UserPreferences.getNotificationFoldedToggle()));
    ...
    private void onListItemClick(SettingTemplate item) {
        ...
        switch (item.getId()) {
            case TAG_HEAD:
                UserProfileSettingActivity.start(this, NimCache.getAccount());
                break;
