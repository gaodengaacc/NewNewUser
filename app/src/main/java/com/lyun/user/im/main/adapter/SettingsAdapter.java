package com.lyun.user.im.main.adapter;
...
public class SettingsAdapter extends BaseAdapter {
    ...
    private void updateHeadItem(ViewHolder viewHolder) {
        ...
        viewHolder.headTitleView.setText(NimUserInfoCache.getInstance().getUserDisplayName(NimCache.getAccount()));
        viewHolder.headDetailView.setVisibility(View.VISIBLE);
        viewHolder.headDetailView.setText(String.format("帐号:%s", NimCache.getAccount()));
        viewHolder.titleView.setVisibility(View.GONE);
        viewHolder.headImageView.loadBuddyAvatar(NimCache.getAccount());
