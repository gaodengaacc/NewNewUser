package com.lyun.user.im.config.preference;
...
public class UserPreferences {
    ...
    private static StatusBarNotificationConfig getConfig(String key) {
        ...
        try {
            ...
            config.downTimeBegin = jsonObject.get("downTimeBegin").getAsString();
            config.downTimeEnd = jsonObject.get("downTimeEnd").getAsString();
            config.downTimeToggle = jsonObject.get("downTimeToggle").getAsBoolean();
            config.ring = jsonObject.get("ring").getAsBoolean();
            config.vibrate = jsonObject.get("vibrate").getAsBoolean();
            config.notificationSmallIconId = jsonObject.get("notificationSmallIconId").getAsInt();
            config.notificationSound = jsonObject.get("notificationSound").getAsString();
            config.hideContent = jsonObject.get("hideContent").getAsBoolean();
            ...
            config.titleOnlyShowAppName = jsonObject.get("titleOnlyShowAppName").getAsBoolean();
            config.notificationFolded = jsonObject.get("notificationFolded").getAsBoolean();
        } catch (Exception e) {
            e.printStackTrace();
        }
