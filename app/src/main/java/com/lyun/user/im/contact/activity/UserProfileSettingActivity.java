package com.lyun.user.im.contact.activity;
...
import com.lyun.user.im.contact.constant.UserConstant;
import com.lyun.user.im.contact.helper.UserUpdateHelper;
...
public class UserProfileSettingActivity extends UI implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.setTitleId(R.string.user_information);
