...
import com.lyun.user.im.main.adapter.SystemMessageAdapter;
import com.lyun.user.im.main.viewholder.SystemMessageViewHolder;
...
public class SystemMessageActivity extends UI implements TAdapterDelegate,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.setTitleId(R.string.verify_reminder);
